...
tbl_sens_country <- readr::read_delim("tables/table_B-1.txt",
                                      delim = "|", trim_ws = TRUE)

tbl_sens_date <- readr::read_delim("tables/table_B-2.txt",
                                   delim = "|", trim_ws = TRUE)

tbl_sens_wght <- readr::read_delim("tables/table_B-3.txt",
                                   delim = "|", trim_ws = TRUE)

tbl_sens_base <- readr::read_delim("tables/table_B-4.txt",
                                  delim = "|", trim_ws = TRUE)

tbl_sens_imp <- readr::read_delim("tables/table_B-5.txt",
                                  delim = "|", trim_ws = TRUE)

```

# Sensitivity analysis &ndash; detailed results {#sec-sensitivity-detailed}
